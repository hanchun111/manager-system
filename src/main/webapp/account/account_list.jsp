...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            $(function() {
                $.ajax({
                    url: "http://localhost:8080/Porjectuser/show",
                    type: "get",
                    dataType: "json",
                    success: function(responseText) {
                        ...
                        for (var i = 0; i < json.length; i++) {
                            ...
                            var row = json[i];
                            tbody += "<td>" + (i + 1) + "</td>";
                            tbody += "<td>" + row["accoutId"] + "</td>";
                            tbody += "<td>" + row["recommenderId"] + "</td>";
                            tbody += "<td>" + row["loginName"] + "</td>";
                            tbody += "<td>" + row["status"] + "</td>";
                           /* tbody += "<td>" + '<a class="btn btn-primary"  href="http://localhost:8080/user/delete.do?username=' + row["userId"] + '">删除</a>&nbsp' +
                                '<button class="btn btn-primary update" data-toggle="modal" data-target="#updateUser">修改</button>' +
                                "</td>";*/
                            tbody += "</tr>";
                        }
                        $("#datalist tbody").append(tbody);
                    },
